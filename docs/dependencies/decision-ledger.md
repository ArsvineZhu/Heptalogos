...
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | -----------: | --------------------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| JavaScript Runtime                    | Node.js 24 LTS line；exact shipping patch pin；当前 L0 baseline `24.19.0`                                                |      ADOPTED |                    REQUIRED | runtime API Authority；具体 release/platform/source-less 由产品资格确认                                                                                                                                     |
| Build/tooling                         | pnpm 11 / Nx 23.x / TypeScript 7.0.x primary + TS6 compiler-API compatibility lane / ESLint 10.x + typescript-eslint 8.x |      ADOPTED |                    REQUIRED | ESNext/NodeNext/ESM-first；exact versions 由 Catalog pin；`C-TOOLCHAIN-01`                                                                                                                                  |
...
| AI SDK                                | AI SDK 7 line                                                                                                            |      ADOPTED |                    REQUIRED | provider/model/tool/structured-output mechanics                                                                                                                                                             |
...
| Bootstrap lock                        | `@bybrave/proper-lockfile2` 5.0.0                                                                                        |      ADOPTED |                    REQUIRED | 仅覆盖 pre-PostgreSQL ownership window；正常 Host Authority 是 PostgreSQL lease + HostOwnershipFence                                                                                                        |
| Bootstrap process liveness            | Node `process.kill(pid, 0)` + `pidusage` 4.0.1                                                                           |      ADOPTED |                    REQUIRED | 仅用于 abandoned bootstrap-owner process-generation 判定；UNKNOWN fail-closed                                                                                                                               |
...
```text
pre-PostgreSQL lock → @bybrave/proper-lockfile2 5.0.0
