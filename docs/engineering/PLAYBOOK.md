...
| [Pre-production stabilization closure](playbooks/repository/pre-production-stabilization-closure.md) | Stabilization branch, live PR candidate and closure gates     | current plan + manual verify workflow |
...
| [Source documentation](playbooks/repository/source-documentation.md)                                 | Durable module and exported-contract documentation            | `repository:source-docs:lint`         |
