...
- M5B exact candidate `e7e46e8` has PASS evidence for Linux restart-success/live-owner-block/corrupt-journal subsets, K1-K3 process qualification, real K4/K5 maintenance/recovery, and the complete live PG-1..PG-9 matrix (11/11 including 5B/6A/6B split cases). The prior review of exact HEAD `9e450f836466d32fb1f3d9027618fac236798eb9` returned `REQUEST_CHANGES`; the current candidate awaits independent review, so final CI and merge remain unauthorized. Windows/macOS real PostgreSQL, source-less recovery, service-account ACL, and hardware power-loss remain `NOT_RUN`; H1 remains OPEN.
