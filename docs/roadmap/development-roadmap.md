...
- M5B behavior candidate `c4c1be43f412c868a84a776461b479d3b677ea18` has PASS evidence for Linux restart-success/live-owner-block/corrupt-journal subsets, K1-K3 process qualification, H1 unit regressions, same-lock reclaim, live-owner no-steal, and fixed INSPECT/RECOVER command boundaries. Review of exact HEAD `9e450f836466d32fb1f3d9027618fac236798eb9` returned `REQUEST_CHANGES`; K4/K5 actual maintenance/recovery and PG-1..PG-9 remain `NOT_RUN`, as do final CI, merge, Windows/macOS real PostgreSQL, source-less recovery, service-account ACL, and hardware power-loss. H1 remains OPEN.
