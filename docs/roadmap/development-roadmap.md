...
- M5B behavior candidate `c4c1be43f412c868a84a776461b479d3b677ea18` has PASS Linux evidence: PostgreSQL 18.6 recovery integration, real process K1-K5 qualification, H1 unit/integration regressions, same-lock reclaim, live-owner no-steal, and fixed INSPECT/RECOVER command boundaries. Independent review, final CI, merge, Windows/macOS real PostgreSQL, source-less recovery, service-account ACL, and hardware power-loss remain `NOT_RUN`; H1 remains OPEN.
