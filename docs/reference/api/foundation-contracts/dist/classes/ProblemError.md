...
[heptalogos](../../../README.md) / [foundation-contracts/dist](../README.md) / ProblemError

# Class: ProblemError

Defined in: packages/foundation-contracts/dist/problem.d.ts:36
...
> **new ProblemError**(`problem`, `options?`): `ProblemError`

Defined in: packages/foundation-contracts/dist/problem.d.ts:39
...
> `readonly` **problem**: [`Problem`](../interfaces/Problem.md)

Defined in: packages/foundation-contracts/dist/problem.d.ts:37
