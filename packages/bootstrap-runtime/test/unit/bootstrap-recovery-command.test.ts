...
import type { BootstrapRecoveryInspection } from "../../src/bootstrap-recovery.js";
...
vi.mock("../../src/host-maintenance-recovery.js", async () => {
  const actual = await vi.importActual<
    typeof import("../../src/host-maintenance-recovery.js")
  >("../../src/host-maintenance-recovery.js");
...
const { executeBootstrapRecoveryCommand, parseBootstrapRecoveryCommand } =
  await import("../../src/bootstrap-recovery-command.js");
