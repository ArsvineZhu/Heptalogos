...
| [network-access](./network-access/README.md) | Gateway-derived origin, method, redirect, deadline, and byte-budget policy.           |
| [ai-runtime](./ai-runtime/README.md)         | GatewayProfile/ModelProfile/ModelBinding and structured protocol generation boundary. |
