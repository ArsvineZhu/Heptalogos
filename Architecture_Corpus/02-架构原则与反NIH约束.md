...
> 长期稳定的项目宪法与工程宪法见 `00-项目宪法与工程宪法.md`。
...
Repository language baseline 见 `25-TypeScript与仓库工具链.md`：TypeScript 7 primary + ESNext/NodeNext/ESM-first，TS6 仅为受隔离的 compiler-API compatibility lane。
