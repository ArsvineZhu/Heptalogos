...
| Bootstrap single-instance lock | `proper-lockfile` 4.x | pre-PostgreSQL bootstrap ownership adapter | second long-lived Host ownership system / ad-hoc stale-lock protocol |
