...
| Bootstrap lock | `proper-lockfile` 4.x | ADOPTED | REQUIRED | power-loss/platform/source-less |
...
proper-lockfile bootstrap lock
pacote
Execa
...
完整 import/boundary directive 见 `../24-依赖使用与实现路由.md`。
