...
Detailed guidance: `25-TypeScript与仓库工具链.md`; pre-implementation conformance: `C-TOOLCHAIN-01`.
...
对于本账本中 `ADOPTED` 的角色，代码实现必须遵守 `24-依赖使用与实现路由.md` 与 `references/dependency-routing.json`。
