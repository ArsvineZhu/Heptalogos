...
**Canonical historical path:** `docs/plans/superseded/repository/agent-harness-capability-correction-2026-08-30.md`

## Supersession

Accepted:

- typed Architecture/Spec separation;
- open Skill discovery;
- deepened existing procedural Skills;
- retrieval-oriented index direction.

Superseded because governance contradictions remained: nested AGENTS files were
still artificially forbidden, package README and INDEX roles remained mixed,
semantic-density and positive-first authoring were not persistently scoped,
generalized Agent overengineering and mandatory mechanics preflight were not
fully modeled, and blanket TDD and disabled-CI contradictions remained.
