...
> This plan is retained as a historical implementation record. The active
> repository-stabilization route is the mechanics ownership and library-first
> convergence plan.
...
**Historical repository location:** `docs/plans/superseded/repository/repository-stabilization-topology-reset-2026-08-27.md`
...
```json
{
  ...
  "workspaces": {
    ".": {
      "entry": ["scripts/**/*.mjs", ".agents/**/*.mjs"],
      "project": ["scripts/**/*.mjs", ".agents/**/*.mjs"]
    },
    "packages/*": {
